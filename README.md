...
Все диаграммы доступны в папке `/docs`, ознакомиться с работой вы можете, открыв файл !([Спецификация.md](https://github.com/besanna/TV-Show_pet-project/blob/main/Спецификация.md))
