...
Ознакомиться с работой вы можете, открыв файл [Спецификация](https://github.com/besanna/TV-Show_pet-project/blob/main/Спецификация.md).
...
Все диаграммы доступны в папке `/docs`, ознакомиться с работой вы можете, открыв файл [Спецификация](https://github.com/besanna/TV-Show_pet-project/blob/main/Спецификация.md).
